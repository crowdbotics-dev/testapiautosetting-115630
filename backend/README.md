...
## Project Structure
    ...
    ├── testapiautosetting_115630  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_115630`
...
2. Clone this repo and `cd testapiautosetting_115630`
